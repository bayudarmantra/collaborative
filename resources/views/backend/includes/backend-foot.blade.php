            ...
            success: function (response) {
                ...
                $.each(response, function (i, data) {
                    $("table#table-mhs tbody").append(
                            "<tr><td><input type=checkbox name=nim[] value=" + data['nim'] + "></td><td>" + data['nim'] + "</td><td>" + data['nama'] + "</td></tr>").hide().fadeIn(500);
                });
            ...
            success: function (response) {
                ...
                $.each(response, function (i, data) {
                    $("table#table-mhskelas tbody").append(
                            "<tr><td>" + no + "</td><td>" + data['nim'] + "</td><td>" + data['mhs']['nama'] + "</td></tr>").hide().fadeIn(500);
                    no++;
                });
            }
        }); // End of ajax call
